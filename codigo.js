...
Bryan Alexander Díaz Vásquez - DV21005*/
...
function eliminarProducto(boton) {
	...
	fetch("https://retoolapi.dev/dfAMHe/productos" + informacionFila, { method: "delete" })
		.then(res => res.json())
...
function obtenerProductos() {
	fetch('https://retoolapi.dev/dfAMHe/productos')
		.then(res => res.json())
